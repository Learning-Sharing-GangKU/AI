...
class ClusterRefreshRequest(BaseModel):
    ...
    """
    users: List[RecommendByClusteringModelRequest]


class ClusterRefreshResult(BaseModel):
    """
    ...
    iner_evaluation: List[float] = Field(
        ...,
        description="K-means의 실루엣, SSE, dunn index값을 구해서 넘겨줄 것"
    )
